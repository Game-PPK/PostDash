            ...
            <div className="bg-gradient-to-br from-indigo-700 to-slate-900 p-5 rounded-3xl shadow-xl mb-8 relative overflow-hidden group border border-white/10 text-white">
               ...
               <div className="relative z-10">
                  <div className="flex items-center gap-3 mb-5 pb-4 border-b border-white/5">
                     ...
                     <div>
                        <h4 className="text-lg font-black tracking-tight uppercase">AI Data Intelligence</h4>
                        <p className="text-indigo-200/70 text-[10px] font-black opacity-70 tracking-widest leading-none">AI STRATEGIC ANALYSIS • {filterMonth === 'All' ? 'Latest' : filterMonth}</p>
                     </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                     ...
                     <div className="lg:col-span-5 bg-white/5 p-4 rounded-2xl border border-white/5 backdrop-blur-md">
                        <h5 className="text-sm font-black text-white mb-2 flex items-center gap-2">
                           <Activity size={18} className="text-emerald-400" /> Executive Summary
                        </h5>
                     ...
                     <div className="lg:col-span-7 flex flex-col justify-center space-y-3">
                        {aiInsights ? Object.entries(aiInsights).filter(([k]) => k !== 'overall').map(([key, item], i) => (
                           ...
                           <div className="text-indigo-300 text-xs italic py-2">ไม่มีข้อมูลเพียงพอสำหรับการวิเคราะห์เชิงลึก</div>
                        )}
                     </div>
                  </div>
               </div>
